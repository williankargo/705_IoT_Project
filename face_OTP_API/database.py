    ...
    def initialize_db(self):
        try:
            with self.get_db() as db:
                ...
                initial_users = [
                    ("7165470385", self.image_to_blob("./OwnerData/pinkuan.jpg")),
                    ("7165470136", self.image_to_blob("./OwnerData/madhavi.jpg")),
                    ("7165479219", self.image_to_blob("./OwnerData/sandeep.jpg"))
